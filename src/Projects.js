  ...
  return (
   ...
   {/* 1st project */}
    ...
    <div className="project-actual-info">
          ...
          <div>
           <b> A few things are still a work in progress:</b> cart total price, unique user shopping cart, user login/authentication, fix delete (wrong item being deleted from cart), <strike>optimizing app speed (currently, state is not updating quickly enough when adding/deleting cart items)</strike>, refactor to make use of React components as much as possible, <strike>add search-by-category functionality, 'Featured Product of the day', make mobile responsive</strike> + higher resolution responsive. All coming very soon!  
      </div>
      </div>
