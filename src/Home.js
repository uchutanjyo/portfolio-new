      ...
      <div className="section">
        ...
        <div className="home-info">
          ...
          <div className="info-with-links">
            ...
            <br />
            <br /> 
            These are excellent and exciting opportunities where I have grown a
            lot; however, I am looking to join a new team on a full-time or
        ...
        <div className="icons">
          ...
          <div className="icon-container">
            <a
              href="https://github.com/uchutanjyo"
              target="_blank"
              alt="Github"
            >
              <svg
          ...
          <div className="icon-container">
            <a
              href="https://twitter.com/EngererMatthew/"
              target="_blank"
              alt="Twitter"
            >
              <svg
